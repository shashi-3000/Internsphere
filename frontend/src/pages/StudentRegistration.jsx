...
//     // Affirmative Action Data (for PM Scheme)
//     socialCategory: '',
//     isFromRuralArea: '',
...
//                     onChange={handleChange}
//                     className="w-full px-4 py-3 bg-white/5 border border-white/20 rounded-lg text-slate-800 focus:outline-none focus:border-emerald-400 focus:ring-1 focus:ring-emerald-400 transition"
//                   >
...
//                       onChange={handleChange}
//                       className="w-full px-4 py-3 bg-white/5 border border-white/20 rounded-lg text-slate-700 focus:outline-none focus:border-emerald-400 focus:ring-1 focus:ring-emerald-400 transition"
//                     >
...
//               <button
//                 type="submit"
//                 className="px-8 py-3 bg-emerald-600 hover:bg-emerald-700 text-white font-semibold rounded-lg shadow-lg transition"
//               >
...
export default function StudentRegistration() {
  ...
  const [formData, setFormData] = useState({
    // Basic Info
    fullName: '',
    email: '', // Note: The backend doesn't need this, but it's fine to collect
    phone: '',
    gender: '',
    ...
    technicalSkills: [],
    softSkills: [], // You can add this to your model if you wish
    preferredSectors: [],
